...
class ScraperObserver:
    def __init__(self, scraper_id: str, api_url: str = "http://localhost:8000/api/v1", api_key: str = "dev-secret-key"):
    ...
    def submit_run(self):
        ...
        try:
            ...
            response = requests.post(url, json=self.current_run_data, headers={"X-API-Key": self.api_key})
